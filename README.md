...
MATLAB File Exchange has a file size limit of 250MB. The fully self-contained app could not be made available for download directly from the MATLAB Add-ons. As an alternative, you may download the app from [releases](https://github.com/where-is-brett/cell-fluorescence-ml/releases/tag/0.1.1).
